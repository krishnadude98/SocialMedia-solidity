...
contract Lottery is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    //functions
    constructor(
        address _vrfCoodinatorV2,
        uint256 _entranceFee,
        bytes32 _gasLane,
        uint64 _subsriptionId,
        uint32 _callbackGasLimit,
        uint256 _interval
    ) VRFConsumerBaseV2(_vrfCoodinatorV2) {
        i_entrancefee = _entranceFee;
        i_vrfCoordinator = VRFCoordinatorV2Interface(_vrfCoodinatorV2);
        i_gasLane = _gasLane;
        i_subsriptionId = _subsriptionId;
    ...
    function performUpkeep(bytes calldata /*performData*/) external override {
        ...
        uint256 rwquestId = i_vrfCoordinator.requestRandomWords(
            i_gasLane,
            i_subsriptionId,
        ...
        emit RequestedLotteryWinner(rwquestId);
    }
