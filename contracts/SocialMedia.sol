...
contract SocialMedia {
    ...
    function getPost(uint _postUid) public view returns (Post memory) {
        return posts[_postUid];
    }

    function getIpfsHash(uint _postUid) public view returns (string memory) {
        return posts[_postUid].ipfsHash;
    }
}
